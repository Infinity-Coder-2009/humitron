...
Instead, email us at **security@humitron.com**.
...
2. **Run Humitron in a sandboxed environment** (Docker or VM) for sensitive tasks
3. **Never share your API keys** with untrusted agents
4. **Set budget caps** when using cloud mode to prevent runaway costs

...
import { SearchIcon, SettingsIcon, ProviderIcon, KeyIcon, GlobeIcon, ModelIcon, AlertIcon, CheckIcon } from '../Icons/ProviderIcons';
  ...
  useEffect(() => {
    try {
      ...
      if (stored) {
        ...
        const defaults: AIProvider[] = DEFAULT_PROVIDERS.map((p, i) => ({
          ...p,
          id: `default-${p.type}`,
          apiKey: '',
          enabled: false,
